...
export default function PreviewPage() {
    ...
    return (
<>
    {scriptsArray.length > 0 ? <motion.div className="shopContainer" variants={staggerContainer}
                                           initial="hidden"
                                           whileInView="show"
                                           viewport={{
                                               once: true,
    ...
    >
        ...
        >
            ...
            {scriptsArray.map((item) => {
                return (
                    <motion.div className="shopItem1" variants={childVariant} key={item.id}>
    ...
    </motion.div> : <div className="loading">Loading...</div>}
