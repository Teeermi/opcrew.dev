...
export default function Home() {
  ...
  return (
      <>
        ...
        >
          ...
          <motion.div
              ...
              variants={{
                ...
                show: {
                  opacity: 1,
                  transition: {staggerChildren: 0.1}, // Staggering dla dzieci
                },
              }}
              initial="hidden"
              whileInView="show"
        ...
        {/*    <div className="feed1">*/}
        {/*      <h2>Working with them was pure pleasure; I helped them, and they helped me. Ain’t no party like a PK*/}
        {/*        party</h2>*/}
        ...
        {/*          <h4>The Polish Diddy of FiveM</h4>*/}
        {/*        </div>*/}
        {/*      </div>*/}
        {/*    </div>*/}
        ...
        <footer>
          <div className="leftSide">
            ...
            <h3>opcrew.dev. is a group of developers creating well-thought-out and secure scripts for FiveM, delivering
              excellent quality by utilizing a variety of modern techniques</h3>
            <h4>Disclaimer: This website is in no way affiliated with, authorized, maintained, sponsored or endorsed by
              Rockstar Inc. (rockstar.com) or any of its affiliates or subsidiaries. Images belong to respected
              owners.</h4>
          </div>
